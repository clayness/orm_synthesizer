...
class DBImplementation(path:String) { //extends FrameworkTypeWrapper {

  private var implPath: String = path

  private var dataProvider: DataProvider = new DataProvider()
  private var reverseTAssociate: ArrayList[CodeNamePair[String]] = null
  private var foreignKeys: ArrayList[CodeNamePair[String]] = null
  // HashMap[Association Name, pair[src, dst], src and dst are class name
  private var associations: HashMap[String, CodeNamePair[String]] = null
  private var primaryKeys: ArrayList[CodeNamePair[String]] = null
  private var fields: ArrayList[CodeNamePair[String]] = null
  private var allFields: ArrayList[String] = null
  private var fieldsTable: ArrayList[CodeNamePair[String]] = null
  ...
  def getTypeMapList(): HashMap[String, String] = {
    this.typeMap
  }
  ...
  def getReverseTAssociate(): ArrayList[CodeNamePair[String]] = {
    this.reverseTAssociate 
  }

  def setReverseTAssociate(rTAss: ArrayList[CodeNamePair[String]]) = {
    this.reverseTAssociate = rTAss
  }

  def getForeignKeys(): ArrayList[CodeNamePair[String]] = {
    this.foreignKeys 
  }

  def setForeignKeys(fKeys: ArrayList[CodeNamePair[String]]) = {
    this.foreignKeys = fKeys
  }

  def getAssociations(): HashMap[String, CodeNamePair[String]] = {
    this.associations 
  }

  def setAssociations(ass: HashMap[String, CodeNamePair[String]]) = {
    this.associations = ass
  }

  def getPrimaryKeys(): ArrayList[CodeNamePair[String]] = {
    this.primaryKeys 
  }

  def setPrimaryKeys(pKeys: ArrayList[CodeNamePair[String]]) = {
    this.primaryKeys = pKeys
  }

  def getFields(): ArrayList[CodeNamePair[String]] = {
    this.fields 
  }

  def setFields(fields: ArrayList[CodeNamePair[String]]) = {
    this.fields = fields
  }
  ...
  def getFieldsTable(): ArrayList[CodeNamePair[String]] = {
    this.fieldsTable 
  }

  def setFieldsTable(ft: ArrayList[CodeNamePair[String]]) = {
    this.fieldsTable = ft
  }

  // parse the xml file and store all information back to data structures
  def parseImplXMLFile() = {
    var schemas: HashMap[String, ArrayList[CodeNamePair[String]]] = new HashMap[String, ArrayList[CodeNamePair[String]]]()
  ...
  def getDataSchemas(): HashMap[String, ArrayList[CodeNamePair[String]]] = {

...
public class SolveAlloyDM {
	 ...
	 */
	HashMap<String, HashMap<String, ArrayList<CodeNamePair<String>>>> schemas = new HashMap<String, HashMap<String, ArrayList<CodeNamePair<String>>>>();
	HashMap<String, ArrayList<CodeNamePair<String>>> parents = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	...
	HashMap<String, ArrayList<CodeNamePair<String>>> reverseTAss = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	HashMap<String, ArrayList<CodeNamePair<String>>> foreignKeys = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	HashMap<String, HashMap<String, CodeNamePair<String>>> associations = new HashMap<String, HashMap<String, CodeNamePair<String>>>();
	HashMap<String, ArrayList<CodeNamePair<String>>> primaryKeys = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	// HashMap<String, ArrayList<CodeNamePair<String>>> fields = new
	// HashMap<String, ArrayList<CodeNamePair<String>>>();
	...
	HashMap<String, ArrayList<CodeNamePair<String>>> fieldsTable = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	HashMap<String, ArrayList<CodeNamePair<String>>> tableFields = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	HashMap<String, ArrayList<CodeNamePair<String>>> fieldType = new HashMap<String, ArrayList<CodeNamePair<String>>>();
	...
	public void printAllStatements(int i) {
		...
		// ArrayList<CodeNamePair<String>>>> entry : schemas.entrySet()) {
		// String dbSchemaFile = entry.getKey(); // this file include .sql
		// extension
	...
	public void parseSelect(String alloyDMSolFile) {
		...
		for (int i = 0; i < 1; i++) {
			...
			for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> entry : schemas
				...
				ArrayList<CodeNamePair<String>> unCoveredFields = new ArrayList<CodeNamePair<String>>(
				...
				// for (CodeNamePair<String> field_table : unCoveredFields) {
				int iterator = unCoveredFields.size() - 1;
				for (; iterator >= 0; iterator--) {
					CodeNamePair<String> field_table = unCoveredFields
							.get(iterator);
				...
				do {
					...
					for (String tableName : tables) {
						// for (CodeNamePair<String> field_table :
						// fieldsTable.get(dbSchemaFile)) {
						for (CodeNamePair<String> field_table : unCoveredFields) {
	...
	public String getFieldType(String scheme, String field) {
		ArrayList<CodeNamePair<String>> types = this.fieldType.get(scheme);
		for (CodeNamePair<String> field_type : types) {
	...
	public String getIDByField(String scheme, String field) {
		...
		// belongs to
		for (CodeNamePair<String> pair : this.tableFields.get(scheme)) {
			if (pair.getSecond().equalsIgnoreCase(field))
	...
	public boolean isPrimaryKeys(String dbScheme, String table, String field) {
		ArrayList<CodeNamePair<String>> keys = this.primaryKeys.get(dbScheme);
		for (CodeNamePair<String> s : keys) {
	...
	public void generateSelect1() {
		...
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> instances : this.allInstances
				.entrySet()) {
			...
			for (Map.Entry<String, ArrayList<CodeNamePair<String>>> instance : instances
					.getValue().entrySet()) {
				for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> omClass : this.schemas
						.entrySet()) {
					selectPart = "SELECT ";
					fromPart = " FROM ";
					wherePart = " WHERE ";
		...
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> instances : this.allInstances
			...
			for (Map.Entry<String, ArrayList<CodeNamePair<String>>> instance : instances
				...
				for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> omClass : this.schemas
					...
					ArrayList<CodeNamePair<String>> allAboutOMClass = omClass
	...
	public ArrayList<String> getOffSprings(String dbScheme, String element) {
		...
		ArrayList<CodeNamePair<String>> parents = this.parents.get(dbScheme);
		for (CodeNamePair<String> pair : parents) {
	...
	public void generateInsert() {
		...
		ArrayList<HashMap<String, CodeNamePair<String>>> associations = new ArrayList<HashMap<String, CodeNamePair<String>>>();
		HashMap<String, CodeNamePair<String>> ass;
		// start with the instances
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> instances : this.allInstances
				.entrySet()) {
							...
							if (value != null) {
								...
								if (field.equalsIgnoreCase("DType")) {
									...
									if (isForeignKey) {
										...
										for (HashMap<String, CodeNamePair<String>> tmp_ass : associations) {
											for (Map.Entry<String, CodeNamePair<String>> ass_entry : tmp_ass
													.entrySet()) {
							...
							if (value != null) {
								...
								if (field.equalsIgnoreCase("DType")) {
									...
									if (isForeignKey) {
										...
										// the list of associations
										for (String fTable : fTables) {
											HashMap<String, CodeNamePair<String>> ass = getAssByKey(
										...
										for (HashMap<String, CodeNamePair<String>> ass : associations) {
											for (Map.Entry<String, CodeNamePair<String>> ass_entry : ass
													.entrySet()) {
												// need the value of id, srcdst,
												// srcdst1
												String para = null;
	...
	public ArrayList<String> getTablesByPrimaryKey(String scheme,
			String primaryKey) {
		ArrayList<String> tables = new ArrayList<String>();
		ArrayList<CodeNamePair<String>> pairs = this.primaryKeys.get(scheme);
		for (CodeNamePair<String> pair : pairs) {
	...
	public boolean isForeignKey(
			HashMap<String, ArrayList<CodeNamePair<String>>> scheme,
			String table, String field) {
		for (CodeNamePair<String> pair : scheme.get(table)) {
	...
	public String getFieldValue(ArrayList<CodeNamePair<String>> instance,
			String field) {
		String value = null;
	...
	public String getFTableByForeignKey(String scheme, String primaryKey) {
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> entry : this.schemas
				.entrySet()) {
			if (entry.getKey().equalsIgnoreCase(scheme)) {
				for (Map.Entry<String, ArrayList<CodeNamePair<String>>> table : entry
						.getValue().entrySet()) {
					for (CodeNamePair<String> pair : table.getValue()) {
	...
	public String getForeignKeyValue(
		...
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> instance : this.allInstances
				.entrySet()) {
			if (instance.getValue().equals(in_instance)) {
				for (Map.Entry<String, ArrayList<CodeNamePair<String>>> s_inst : instance
						.getValue().entrySet()) {
					...
					if (asso.equalsIgnoreCase(instance.getKey())) {
						...
						for (CodeNamePair<String> pair : s_inst.getValue()) {
	...
	public String getPrimaryKeyByTableName(
			HashMap<String, ArrayList<CodeNamePair<String>>> scheme,
			String tableName) {
		ArrayList<CodeNamePair<String>> table = scheme.get(tableName);
		for (CodeNamePair<String> pair : table) {
			if (pair.getFirst().equalsIgnoreCase("primaryKey")) {
				return pair.getSecond();
			}
		}
	...
	public HashMap getAssByKey(String scheme, String pTable, String fTable) {
		...
		String dst = "";
		String ass = "";
		HashMap<String, ArrayList<CodeNamePair<String>>> single_scheme = this.schemas
				.get(scheme);
		for (Map.Entry<String, ArrayList<CodeNamePair<String>>> entry : single_scheme
				.entrySet()) {
			for (CodeNamePair<String> pair : entry.getValue()) {
			...
			if (src.length() > 0 && dst.length() > 0) {
				ass = entry.getKey();
				CodeNamePair<String> pair = new CodeNamePair<String>(src, dst);
	...
	public ArrayList<String> getForeignKey(String schema, String element) {
		...
		for (Map.Entry<String, ArrayList<CodeNamePair<String>>> entry : this.foreignKeys
				.entrySet()) {
			if (entry.getKey().equalsIgnoreCase(schema)) {
				for (CodeNamePair<String> table_key_pair : entry.getValue()) {
	...
	public String getTableNameByElement(String schema, String element) {
		ArrayList<CodeNamePair<String>> entry = this.reverseTAss.get(schema);
		if (entry != null) {
			for (CodeNamePair<String> pair : entry) {
	...
	public boolean childIsTable(String dataSchema, String child) {
		for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> entry : this.schemas
			...
			if (entry.getKey().equalsIgnoreCase(dataSchema)) {
				HashMap<String, ArrayList<CodeNamePair<String>>> value = entry
						.getValue();
				for (Map.Entry<String, ArrayList<CodeNamePair<String>>> single_table : value
						.entrySet()) {
	...
	// Collection<HashMap<String, ArrayList<CodeNamePair<String>>>> instTables =
	// this.tables.values();
	// for (HashMap<String, ArrayList<CodeNamePair<String>>> instTable :
	// instTables) {
	// for (Map.Entry<String, ArrayList<CodeNamePair<String>>> inst :
	// instTable.entrySet()) {
	...
	public ArrayList<String> getChildren(String schemaName, String tableName) {
		ArrayList<String> children = new ArrayList<String>();
		for (Map.Entry<String, ArrayList<CodeNamePair<String>>> entry : this.parents
				.entrySet()) {
			String key = entry.getKey();
			if (key.equalsIgnoreCase(schemaName)) {
				ArrayList<CodeNamePair<String>> value = entry.getValue();
				for (CodeNamePair<String> pair : value) {
			...
			for (Sig sig : this.sigs) {
				...
				if (sig.category == 0) { // 0 is class
					...
					this.allInstances
							.get(sigName)
							.get(instanceName)
							.add(new CodeNamePair<String>(sigName + "_" + id,
									fieldValue));
					for (String fieldName : sig.attrSet) {
						...
						this.allInstances
								.get(sigName)
								.get(instanceName)
								.add(new CodeNamePair<String>(sigName + "_"
	...
	public void randomSelectGenarator(int i, int range) {
		...
		for (; i < range; i++) {
			...
			for (Map.Entry<String, HashMap<String, ArrayList<CodeNamePair<String>>>> entry : schemas
				...
				// ArrayList<CodeNamePair<String>> fieldsCoveredByTable = new
				// ArrayList<CodeNamePair<String>>();
						...
						for (int j = 0; j < children.getLength(); j++) {
							...
							if (child.hasChildNodes()) { // for every <tuple>
								...
								String instanceName = getSingleAtom(
										singleTuple, 0); // Get the first part
								...
								this.allInstances
										.get(table_name)
										.get(instanceName)
										.add(new CodeNamePair<String>(field,
												value));
							}
						}
					}
